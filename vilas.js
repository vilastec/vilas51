...
function setupMain(){
    ...
    function changeBannerText() {
        const phrases = [ "Vilaaaaaaaaaaaaaaaaaaaaaaaaaaaaassssssssssssssss" ];
        setInterval(() => { 
...
/* Inject */
if (!/^https?:\/\/hi\.khanacademy\.org/.test(window.location.href)) { alert("Falha ao injetar!\n\nVocê precisa executar o virus no site do Khan Academy! (https://hi.khanacademy.org/)"); window.location.href = "https://hi.khanacademy.org/";};
...
.then(async () => {
    sendToast("Virus injetado com sucesso!");
